...
function displayPics() {
  ...
  // The previous line threw an error because rando is declared with const inside of the displayPics() function, which means it will only exist in that function scope. If we used var instead of const the error would be gone because var will be globally scoped
